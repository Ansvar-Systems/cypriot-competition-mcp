...
/**
 * Cypriot Competition MCP — stdio entry point.
 *
 * Provides MCP tools for querying CPC-CY (Commission for the Protection of
 * Competition — Cyprus) decisions, merger control cases, and sector enforcement
 * activity under Cypriot competition law.
 *
 * Tool prefix: cy_comp_
 */
...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across CPC-CY (Commission for the Protection of Competition) enforcement decisions covering abuse of dominance, cartel enforcement, and sector inquiries under Cypriot competition law (Law 13(I)/2022). Returns matching decisions with case number, parties, outcome, fine amount, and legal articles cited.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: {
          type: "string",
          description: "Search query (e.g., 'abuse of dominance', 'price fixing', 'market concentration')",
        },
        type: {
          type: "string",
        ...
        sector: {
          type: "string",
          description: "Filter by sector ID (e.g., 'banking', 'telecommunications', 'energy'). Optional.",
        },
        outcome: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        case_number: {
          type: "string",
          description: "CPC-CY case number (e.g., '27/2023', '18/2022')",
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: {
          type: "string",
          description: "Search query (e.g., 'banking sector merger', 'telecom acquisition', 'retail concentration')",
        },
        sector: {
          type: "string",
          description: "Filter by sector ID (e.g., 'banking', 'telecommunications', 'retail'). Optional.",
        },
        outcome: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        case_number: {
          type: "string",
          description: "CPC-CY merger case number (e.g., 'M-12/2023')",
        },
      },
      required: ["case_number"],
    },
